...
module.exports = {
    ...
    PERSON_UNLINK_FAILURE: errorMessage("Wystąpił problem podczas odłączania Twojego konta rejestracyjnego."),
    PERSON_RESYNC_SUCCESS: "Synchronizacja osoby zakończyła się pomyślnie.",
    PERSON_RESYNC_FAILURE: errorMessage("Wystąpił problem podczas ponownej synchronizacji osoby."),
    PERSON_UNLINK_CONFIRMATION_1: "Spowoduje to odłączenie Twojego konta rejestracyjnego od Twojego konta Planorama. Nie spowoduje to usunięcia Twoich danych z innych systemów konwentowych.",
    PERSON_UNLINK_CONFIRMATION_2: "Czy na pewno chcesz wykonać tę akcję?",
    PERSON_CON_STATE: {
    ...
    CONFIGURATION_LABEL_OVERRIDES: {
        event_virtual: "Czy to wydarzenie obejmuje komponent online?",
        clyde_base_url: "Bazowy adres URL dla Clyde",
        profile_show_info_demographic_community: "Pokaż dane demograficzne, społeczność i informacje w profilu"
    },
