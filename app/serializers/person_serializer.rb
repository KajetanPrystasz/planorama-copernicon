...
#  custom_published_name                   :string
#  custom_published_name_sort_by           :string
...
#  phone_number                            :string(100)      default("")
#  pronouns                                :string(400)
#  pseudonym                               :string
...
class PersonSerializer #< ActiveModel::Serializer
  ...
  protected_attributes :id, :lock_version,
              :name, :surname, :name_sort_by, :name_sort_by_confirmed,
              :pseudonym, :pseudonym_sort_by, :pseudonym_sort_by_confirmed,
              :published_name, :published_name_sort_by,
              :custom_published_name, :custom_published_name_sort_by, :custom_published_name_sort_by_confirmed,
              :phone_number, :of_age_at_convention_time,
              :full_name,
